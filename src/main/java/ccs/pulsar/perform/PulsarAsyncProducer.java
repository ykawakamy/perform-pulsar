...
public class PulsarAsyncProducer {
    private static final Logger log = LoggerFactory.getLogger(PulsarAsyncProducer.class);
        ...
        try {
            ...
            for( int i=0 ; i != iter ; i++ ) {
                ...
                while( (et = System.nanoTime()) - st < loop_ns) {
                    try {
                        producer.sendAsync(serializer.serialize(null, new LatencyMeasurePing(seq)));
                        seq++;
                        cnt++;
